					...
					<div class="coupon_detail_box">
						<table>
								...
								<th class="three">
									<p>
										...
										<select name="" id="select_coupon">
                                            ...
                                            <?php if(is_array($couponTypes)): foreach($couponTypes as $key=>$couponType): ?><option value="<?php echo ($couponType["coupon_id"]); ?>"><?php echo ($couponType["name"]); ?></option><?php endforeach; endif; ?>
										</select>
									</p>
								</th>
                            ...
                            <?php if(is_array($coupon_info)): foreach($coupon_info as $key=>$coupon): ?><tr>
								...
								<td><a href="/index.php/Coupon/detail/<?php echo ($coupon["coupon_id"]); ?>"><?php echo ($coupon["name"]); ?></a></td>
