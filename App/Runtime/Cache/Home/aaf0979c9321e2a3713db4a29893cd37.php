...
<div id="left_card">
	<p class="one">关于我们</p>
	<p class="two">作为有思想、有追求、有目标的大学生，我们总是有很多东西想要去体验，却苦于囊中羞涩，仅有的生活费又无力支持这种消费。几个来自不同学校毕业的年轻人，深知这种无奈与痛楚，一起创办了“惠校园网”，致力于改变这种现状！</p>
	<p class="three">我们提供的解决方案是：帮助学生洽谈最贴近生活的商家的优惠，比如快餐、打印、生活学习用品。
</p>
	<p class="four">惠校园，<a href="<?php echo U('Index/index');?>">www.huixiaoyuan.com</a>Less money, More things!</p>
	<ul>
		<li>
