	...
	<form id="recommend_sumbit_form">
		...
		<ul>
			<li>
				...
				<input type="text" name="nickname" class="one" id="recommend_username" />
			</li>
			<li>
				<p class="title">您的电话：</p>
				<input type="text" name="cellphone" class="one" id="recommend_cellphone"/>
			</li>
			<li class="one">
			...
			<li>
				...
				<input type="text" name="shopname" class="one" id="recommend_business" />
			</li>
			<li>
				<p class="title">商户地址：</p>
				<input type="text" name="companyaddress" class="one" id="recommend_address"/>
			</li>
			<li>
				<p class="title">商户特色商品：</p>
				<input type="text" name="specialproduct" class="one" id="recommend_product"/>
			</li>
			<li class="two">
