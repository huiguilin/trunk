...
<!-- 
		...
		<div id="partner_box">
			...
			<?php if(is_array($partners)): foreach($partners as $key=>$partner): ?><div id="partner_content_box">
				...
				<?php if(is_array($coupons)): foreach($coupons as $k=>$coupon): if($coupon['partner_id'] == $partner['partner_id']): ?><div class="partner_coupon_info_box">
					<ul>
...
<script type="text/javascript">
	var ps = $('#main #partner_content_box div.partner_coupon_info_box ul li p.countdown_box');
