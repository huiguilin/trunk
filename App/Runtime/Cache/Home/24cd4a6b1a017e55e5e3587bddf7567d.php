						...
						<div id="all_coupon_info">
                           <ul class="coupon_content clearfix">
                           		...
                           		<?php if($i == '0'): ?><li class="no_margin_left">
										...
										<?php else: ?>
											<?php if($partnercoupon['coupon_type'] == 2): ?><a href="<?php echo U("Coupon/detail","","","");?>/<?php echo ($partnercoupon["coupon_id"]); ?>/specialcoupon" class="img_box"><img src="__PUBLIC__/<?php echo ($partnercoupon["header_path"]); ?>" alt="<?php echo ($partnercoupon["name"]); ?>"></a>
											<?php else: ?>
												<a href="<?php echo U("Coupon/detail","","","");?>/<?php echo ($partnercoupon["coupon_id"]); ?>" class="img_box"><img src="__PUBLIC__/<?php echo ($partnercoupon["header_path"]); ?>" alt="<?php echo ($partnercoupon["name"]); ?>"></a><?php endif; endif; ?>
										
										<?php if($get["off_time"] == 1): ?><a class="content_title" title="<?php echo ($partnercoupon["name"]); ?>"><?php echo ($partnercoupon["name"]); ?></a>
										<?php else: ?>
											<?php if($partnercoupon['coupon_type'] == 2): ?><a href="<?php echo U("Coupon/detail","","","");?>/<?php echo ($partnercoupon["coupon_id"]); ?>/specialcoupon" class="content_title" title="<?php echo ($partnercoupon["name"]); ?>"><?php echo ($partnercoupon["name"]); ?></a>
											<?php else: ?>
												<a href="<?php echo U("Coupon/detail","","","");?>/<?php echo ($partnercoupon["coupon_id"]); ?>" class="content_title" title="<?php echo ($partnercoupon["name"]); ?>"><?php echo ($partnercoupon["name"]); ?></a><?php endif; endif; ?>
