...
<div id="left_card">
	<p class="one">网站帮助</p>
	<div id="seach_box">
		<img src="__PUBLIC__/images/ico_help.png" alt="搜索帮助">
		<p>请输入您想要询问的<span>关键词</span>，查找相关问题的答案：</p>
		<label for="help_search_textbox" class="help_search_default_content" id="help_search_default_contents">例如输入"优惠劵",查找"优惠劵"相关问题的答案</label>
		<form method="get" action="<?php echo U('Help/search');?>">
			<input name="keyword" type="text" id="help_search_textbox" />
			<input name="help_btn_search" id="help_btn_search" type="submit" value="搜索"/>
		</form>
	</div>
	<ul>
		<li>
			<img src="__PUBLIC__/images/help_ico01.png" alt="搜索帮助">
			<a href="<?php echo U("Help/faq01");?>" class="one">优惠劵</a>
			<p class='three'>包括如何获取优惠券、优惠段的使用。</p>
		</li>
		<li style="display:none;">
			<img src="__PUBLIC__/images/help_ico02.png" alt="搜索帮助">
			<a href="<?php echo U("Help/faq02");?>" class="one">会员卡/礼品</a>
			<p class='three'>包括电子会员卡的申请，使用以及原实体会员卡积分，礼品券兑换等问题。</p>
		</li>
		<li style="display:none;">
			<img src="__PUBLIC__/images/help_ico03.png" alt="搜索帮助">
		...
		<li>
			<img src="__PUBLIC__/images/help_ico04.png" alt="搜索帮助">
			<a href="<?php echo U("Help/faq05");?>" class="one">订阅/关注</a>
			<p class='three'>包括怎样订阅惠校园优惠信息，会员卡信息，商户促销信息等问题。</p>
		</li>		
	</ul>
...
<!-- 最底部区域结束 -->
<script type="text/javascript">
var helpSearchInput = document.getElementById("help_search_textbox");
	var help_search__default_content = document.getElementById("help_search_default_contents");
	helpSearchInput.onfocus = function(){
		help_search__default_content.style.display = 'none';
	}
	helpSearchInput.onblur = function(){
		var helpSearchInputValue = helpSearchInput.value;
		if (helpSearchInputValue == "") {
			help_search__default_content.style.display = '';
		}
	}
</script>