...
<link rel="stylesheet" type="text/css" href="__PUBLIC__/css/mysetting.css" />
	...
	<ul class="myinfo_box">
		<li>
			...
			<p class="info_item">184****3921</p>
			<a href="" id="modify_cellphone">修改</a>
		</li>
		<li>
			<p class="header">邮箱</p>
			<p class="no_binding_email">尚未绑定邮箱</p>
			<a href="" id="modify_email">立即绑定</a>
		</li>
		<li class="higher">
			<p class="header">昵称</p>
			<p class="info_item">鱼豆豆</p>
			...
			<form method="post" action="<?php echo U("Home/Account/handleChangeCellphone");?>">
				<ul>
					...
					<li class="higher">
						...
						<a class="get_vcode" href="">获取验证码</a>
						<p class="binding_note">将发送到新手机上</p>
			...
			<form method="post" action="<?php echo U("Home/Account/handleChangeEmail");?>">
				<ul>
					...
					<li>
						...
						<img src="<?php echo U("Home/Login/verifyImg");?>" id="binding_email_vcode_img">
			...
			<form method="post" action="<?php echo U("Home/Account/handleChangeNickname");?>">
				<ul>
					<li>
						...
						<p class="old_nickname">dushuren</p>
					</li>
					<li>
						<p class="label">新昵称</p>
			...
			<form method="post" action="<?php echo U("Home/Account/handleChangePassword");?>">
				<ul>
					<li>
						...
						<input type="text" name="binding_old_password" id="binding_old_password" value="*********"/>
