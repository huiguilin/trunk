...
<link rel="stylesheet" type="text/css" href="__PUBLIC__/css/mysetting.css" />
	<p class="sub_title">个人资料</p>
	<ul class="myinfo_box">
		<li>
			<p class="header">手机号</p>
            <?php if($user_setting["phone_number_used"] == 0): ?><a href="" id="modify_cellphone">立即绑定</a>
            <?php else: ?>
			<p class="info_item"><?php echo ($user_setting["phone_number_used"]); ?></p>
			<a href="" id="modify_cellphone">修改</a><?php endif; ?>

		</li>
		<li>
			<p class="header">邮箱</p>
            <?php if($user_setting["email"] == ''): ?><p class="no_binding_email"></p>
			<a href="" id="modify_email">立即绑定</a>
            <?php else: ?>
			<p class="info_item"><?php echo ($user_setting["email"]); ?></p>
			<a href="" id="modify_email">修改</a><?php endif; ?>
		</li>
		<li class="higher">
			<p class="header">昵称</p>
			<p class="info_item"><?php echo ($user_setting["nickname"]); ?></p>
	...
	<div id="modify_cellphone_hidden_box">
		...
		<div class="middle_content_box">
			<form method="post" action="<?php echo U("Home/Account/handleChangeCellphone");?>">
				<ul>
					<?php if($user_setting["phone_number_used"] != 0): ?><li>
						...
						<?php else: ?>
						<?php  $oldphone = trim($user_setting['phone_number_used'],'*'); endif; ?>
					<li class="higher">
						<p class="label">新手机号</p>
						<input type="text" name="binding_new_phone" id="binding_new_phone" />
						<input type="hidden" id="check_oldphone" value="<?php echo ($oldphone); ?>" />
						<input type="hidden" id="nickname" value="<?php echo ($user_setting["nickname"]); ?>" />
		...
		<div class="middle_content_box">
			<form method="post" action="<?php echo U("Home/Account/handleChangeEmail");?>">
				<ul>
					<li>
						<p class="label">用户名</p>
						<input type="text" name="lable_username" id="lable_username" disabled="disabled" value="<?php echo ($user_setting["nickname"]); ?>" />
					...
					<li>
						...
						<img src="<?php echo U("Home/User/verifyImg","","","");?>" id="binding_email_vcode_img">
			...
			<form method="post" action="<?php echo U("Home/Account/handleChangeNickname");?>">
				<ul>
					<li>
						...
						<p class="old_nickname" id="old_nickname"><?php echo ($user_setting["nickname"]); ?></p>
					</li>
					<li>
						<p class="label">新昵称</p>
