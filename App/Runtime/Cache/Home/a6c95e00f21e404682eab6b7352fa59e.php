			...
			<div id="content_box">
				...
				<div id="location_box">
					<p>区域</p><ul class="parent_classification">
						...
						<?php if($get_info["tag"] != '象山区'): ?><li><a href="<?php echo U('Coupon/coupon',array('tag'=>'象山区'),'','');?>">象山区</a></li>
                        <?php else: ?>
						<li><a class="current" href="<?php echo U('Coupon/coupon',array('tag'=>'象山区'),'','');?>">象山区</a></li><?php endif; ?>
                        <?php if($get_info["tag"] != '叠彩区'): ?><li><a href="<?php echo U('Coupon/coupon',array('tag'=>'叠彩区'),'','');?>">叠彩区</a></li>
                        <?php else: ?>
						<li><a class="current" href="<?php echo U('Coupon/coupon',array('tag'=>'叠彩区'),'','');?>">叠彩区</a></li><?php endif; ?>
                        <?php if($get_info["tag"] != '七星区'): ?><li><a href="<?php echo U('Coupon/coupon',array('tag'=>'七星区'),'','');?>">七星区</a></li>
                        <?php else: ?>
						<li><a class="current" href="<?php echo U('Coupon/coupon',array('tag'=>'七星区'),'','');?>">七星区</a></li><?php endif; ?>
                        <?php if($get_info["tag"] != '雁山区'): ?><li><a href="<?php echo U('Coupon/coupon',array('tag'=>'雁山区'),'','');?>">雁山区</a></li>
                        <?php else: ?>
						<li><a class="current" href="<?php echo U('Coupon/coupon',array('tag'=>'雁山区'),'','');?>">雁山区</a></li><?php endif; ?>
					</ul>
					<?php if($_GET['tag'] != ''): ?><div>
							<ul class="child_classification clearfix">
	                            ...
	                            <?php if(is_array($locations)): foreach($locations as $key=>$location): if($get_info['tag'] == $location['belong']): if($get_info['location'] != ''): if($get_info['location'] == $location['id'] ): ?><li><a class="current" href="<?php echo U('Coupon/coupon',array('tag'=>$location['belong'],'location'=>$location['id']),'','');?>"><?php echo ($location["name"]); ?></a></li>
									...
									<?php else: endif; ?>
	                            	<!-- <?php if($get_info['tag'] == $location['belong']): ?><li><a class="current" href="<?php echo U('Coupon/coupon',array('tag'=>$location['belong'],'location'=>$location['id']),'','');?>"><?php echo ($location["name"]); ?></a></li>
	                            	 <?php else: ?> -->
										<!-- <li><a href="<?php echo U('Coupon/coupon',array('tag'=>$location['belong'],'location'=>$location['id']),'','');?>"><?php echo ($location["name"]); ?></a></li> -->
