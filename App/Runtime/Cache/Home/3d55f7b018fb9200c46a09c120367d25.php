...
<!-- 关于我们页面的内容 -->
<div id="left_card">
	<p class="one">惠校园用户协议</p>

	<p class="two">
		惠校园网（www.huigl.com）所提供的各项服务的所有权和运作权均归桂林惠校园网络科技有限公司（以下简称“惠校园”）所有。惠校园用户使用协议（以下简称“本协议”）系由惠校园网用户与惠校园就惠校园网的各项服务所订立的相关权利义务规范。用户通过访问和/或使用本网站，即表示接受并同意本协议的所有条件和条款。惠校园作为惠校园网（www.huigl.com）的运营者依据本协议为用户提供服务。不愿接受本协议条款的，不得访问或使用本网站。
	</p>
	<p class="three">
		惠校园有权对本协议条款进行修改，修改后的协议一旦公布即有效代替原来的协议。用户可随时查阅最新协议。《知识产权声明》及《商户收录声明》为本协议不可分割的组成部分。用户参与惠校园网团购时，还须同意及遵守《团购用户协议》，并遵守相关团购规则。
	</p>
	<p class="four">
		一、服务内容</br></br>
		1、惠校园网运用自己的系统，通过互联网络等方式为用户提供商户信息、点评信息、消费信息、优惠信息、电子会员卡、团购等网络服务。</br>
		2、用户必须自行准备如下设备和承担如下开支：</br>（1）上网设备，包括并不限于电脑或者其他上网终端、调制解调器及其他上网装置;</br>（2）上网开支，包括并不限于网络接入费、上网设备租用费、手机流量费等。</br>
		3、用户提供的注册资料，用户同意：</br>（1）提供合法、真实、准确、详尽的个人资料； </br>（2）如有变动，及时更新用户资料。如果用户提供的注册资料不合法、不真实、不准确、不详尽的，用户需承担因此引起的相应责任及后果，并且四和保留终止用户使用惠校园网各项服务的权利。</br>
		</br>
		二、服务的提供、修改及终止</br></br>
		1、用户在接受惠校园网各项服务的同时，同意接受惠校园网提供的各类信息服务。用户在此授权四和可以向其电子邮件、手机、通信地址等发送商业信息。用户有权选择不接受惠校园网提供的各类信息服务，并进入惠校园网相关页面进行更改。</br>
		2、惠校园网保留随时修改或中断服务而不需通知用户的权利。惠校园网有权行使修改或中断服务的权利，不需对用户或任何无直接关系的第三方负责。</br>
		3、用户对本协议的修改有异议，或对惠校园网的服务不满，可以行使如下权利：</br>
		（1）停止使用惠校园网的网络服务；</br>
		（2）通过客服等渠道告知惠校园网停止对其服务。 结束服务后，用户使用惠校园网络服务的权利立即终止。在此情况下，惠校园网没有义务传送任何未处理的信息或未完成的服务给用户或任何无直接关系的第三方。
		</br>
		</br>
		三、用户信息的保密</br></br>
		1、本协议所称之惠校园网用户信息是指符合法律、法规及相关规定，并符合下述范围的信息：</br>
		（1）用户注册惠校园网或申请惠校园网会员卡时，向惠校园网提供的个人信息；</br>
		（2）用户在使用惠校园网服务、参加网站活动或访问网站网页时，惠校园网自动接收并记录的用户浏览器端或手机客户端数据，包括但不限于IP地址、网站Cookie中的资料及用户要求取用的网页记录；</br>
		（3）惠校园网从商业伙伴处合法获取的用户个人信息；</br>
		（4）其它惠校园网通过合法途径获取的用户个人信息。</br>
		2、惠校园网承诺：</br>
		非经法定原因或用户事先许可，惠校园网不会向任何第三方透露用户的密码、姓名、手机号码等非公开信息</br>
		3、在下述法定情况下，用户的个人信息将会被部分或全部披露：</br>
		（1）经用户同意向用户本人或其他第三方披露；</br>
		（2）根据法律、法规等相关规定，或行政机构要求，向行政、司法机构或其他法律规定的第三方披露；</br>
		（3）其它惠校园网根据法律、法规等相关规定进行的披露。</br>
		</br>
		四、用户权利</br></br>
		1、用户的用户名、密码和安全性</br>
		（1）用户有权选择是否成为惠校园网会员，用户选择成为惠校园网注册用户的，可自行创建、修改昵称。用户名和昵称		的命名及使用应遵守相关法律法规并符合网络道德。用户名和昵称中不能含有任何侮辱、威胁、淫秽、谩骂等侵害他人合法权益的文字。</br>
		（2）用户一旦注册成功，成为惠校园网的会员，将得到用户名（用户邮箱）和密码，并对以此组用户名和密码登入系统后所发生的所有活动和事件负责，自行承担一切使用该用户名的言语、行为等而直接或者间接导致的法律责任。</br>
		（3）用户有义务妥善保管惠校园网账号、用户名和密码，用户将对用户名和密码安全负全部责任。因用户原因导致用户名或密码泄露而造成的任何法律后果由用户本人负责。</br>
		（4）用户密码遗失的，可以通过注册电子邮箱发送的链接重置密码，以手机号码注册的用户可以凭借手机号码找回原密码。用户若发现任何非法使用用户名或存在其他安全漏洞的情况，应立即告知惠校园网。</br>
		2、用户有权在注册并登陆后对站内商户发布客观、真实、亲身体验的点评信息和图片；</br>
		3、用户有权在注册并登陆后自行添加商户、完善站内商户的营业时间、交通等信息；</br>
		4、用户有权根据网站相关规定，在发布点评信息等贡献后，取得惠校园网给予的奖励；</br>
		5、用户有权修改其个人账户中各项可修改信息，自行选择昵称和录入介绍性文字，自行决定是否提供非必填项的内容；</br>
		6、用户有权参加惠校园网社区，并发表符合国家法律规定，并符合惠校园网社区规则的文章及观点；</br>
		7、用户有权根据网站相关规定，获得惠校园网给与的奖励；</br>
		8、用户有权参加惠校园网组织提供的各项线上、线下活动；</br>
		9、用户在取得惠校园网发放的会员卡后，有权至所在城市会员卡商户进行消费、获得折扣或积分、并根据网站相关规定进行积分兑换等。据国家工商总局颁布的《合同违法行为监督处理办法》，自2010年11月起，惠校园网现行有效、各种形式的会员卡（包括但不限于各种商户联名卡等），“最终解释权归惠校园网所有”、“惠校园网拥有此卡内容的最终解释权及变更权”等内容一概废止。
		10、用户有权在惠校园网上自行浏览、下载和使用优惠券。</br>
		11、用户有权下载安装惠校园网手机客户端并使用其功能。</br>
		12、用户有权根据《团购用户协议》及相关团购规则，参加惠校园网团购；</br>
		13用户有权根据惠校园网网站规定，享受惠校园网提供的其它各类服务。</br>
		</br>
		五、用户义务</br></br>
		...
		（9）其他违反宪法和法律行政法规的；</br>
		（10）进行商业广告行为的。</br>
		2、用户不得通过任何手段恶意注册惠校园网站账号，包括但不限于以牟利、炒作、套现、获奖等为目的多个账号注册。用户亦不得盗用其他用户账号。如用户违反上述规定，则惠校园网有权直接采取一切必要的措施，包括但不限于删除用户发布的内容、取消用户在网站获得的星级、荣誉以及虚拟财富，暂停或查封用户账号，取消因违规所获利益，乃至通过诉讼形式追究用户法律责任等。</br>
		3、用户需维护点评的客观、真实性，不得利用惠校园网用户身份进行违反诚信的任何行为，包括但不限于：炒作商户，并向商户收取费用或获取利益；为获得利益或好处，参与或组织撰写及发布虚假点评；以差评威胁，要求商户提供额外的利益或好处；进行其他其它影响点评真实性、客观性、干扰扰乱网站正常秩序的违规行为等。如用户违反上述规定，则惠校园网有权采取一切必要的措施，包括但不限于：删除用户发布的内容、取消用户在网站获得的星级、荣誉以及虚拟财富，暂停或查封用户帐号，取消因违规所获利益，乃至通过诉讼形式追究用户法律责任等。</br>
		4、禁止用户将惠校园网以任何形式作为从事各种非法活动的场所、平台或媒介。未经惠校园网的授权或许可，用户不得借用本站的名义从事任何商业活动，也不得以任何形式将惠校园网作为从事商业活动的场所、平台或媒介。如用户违反上述规定，则惠校园网有权直接采取一切必要的措施，包括但不限于删除用户发布的内容、取消用户在网站获得的星级、荣誉以及虚拟财富，暂停或查封用户帐号，取消因违规所获利益，乃至通过诉讼形式追究用户法律责任等。</br>
		5、用户在惠校园网以各种形式发布的一切信息，均应符合国家法律法规等相关规定及网站相关规定，符合社会公序良俗，并不侵犯任何第三方主体的合法权益，否则用户自行承担因此产生的一切法律后果，且汉涛因此受到的损失，有权向用户追偿。
		</br>
		</br>
		六、知识产权及其它权利</br></br>
		1、用户已经明确阅读，并明确了解本网站的《知识产权声明》。</br>
		2、任何用户接受本协议，即表明该用户主动将其在任何时间段在本站发表的任何形式的信息的著作财产权，包括并不限于：复制权、发行权、出租权、展览权、表演权、放映权、广播权、信息网络传播权、摄制权、改编权、翻译权、汇编权等，以及应当由著作权人享有的其他可转让权利无偿独家转让给惠校园网运营商所有，同时表明该用户许可惠校园网有权利就任何主体侵权而单独提起诉讼，并获得全部赔偿。 本协议已经构成《著作权法》第二十五条所规定的书面协议，其效力及于用户在惠校园网发布的任何受著作权法保护的作品内容，无论该内容形成于本协议签订前还是本协议签订后。</br>
		3、四和是惠校园网的制作者,拥有此网站内容及资源的版权,受国家知识产权保护,享有对本网站各种协议、声明的修改权；未经四和的明确书面许可，任何第三方不得为任何非私人或商业目的获取或使用本网站的任何部分或通过本网站可直接或间接获得的任何内容、服务或资料。任何第三方违反本协议的规定以任何方式，和/或以任何文字对本网站的任何部分进行发表、复制、转载、更改、引用、链接、下载或以其他方式进行使用，或向任何其他第三方提供获取本网站任何内容的渠道，则对本网站的使用权将立即终止，且任何第三方必须按照本公司的要求，归还或销毁使用本网站任何部分的内容所创建的资料的任何副本。</br>
		4、惠校园网未向任何第三方转让本网站或其中的任何内容所相关的任何权益或所有权，且一切未明确向任何第三方授予的权利均归四和所有。未经本协议明确允许而擅自使用本网站任何内容、服务或资料的，构成对本协议的违约行为，且可能触犯著作权、商标、专利和/或其他方面的法律法规，四和保留对任何违反本协议规定的第三方（包括单位或个人等）提起法律诉讼的权利。</br>
		...
		七、拒绝担保与免责</br></br>
		1、惠校园网作为“网络服务提供者”的第三方平台，不担保网站平台上的信息及服务能充分满足用户的需求。对于用户在接受惠校园网的服务过程中可能遇到的错误、侮辱、诽谤、不作为、淫秽、色情或亵渎事件，惠校园网不承担法律责任。</br>
		2、基于互联网的特殊性，惠校园网也不担保服务不会受中断，对服务的及时性、安全性都不作担保，不承担非因惠校园网导致的责任。惠校园网力图使用户能对本网站进行安全访问和使用，但惠校园网不声明也不保证本网站或其服务器是不含病毒或其它潜在有害因素的；因此用户应使用业界公认的软件查杀任何自惠校园网下载文件中的病毒。</br>
		3、惠校园网不对用户所发布信息的保存、修改、删除或储存失败负责。对网站上的非因惠校园网故意所导致的排字错误、疏忽等不承担责任。惠校园网有权但无义务，改善或更正本网站任何部分之疏漏、错误。</br>
		4、除非惠校园网以书面形式明确约定，惠校园网对于用户以任何方式（包括但不限于包含、经由、连接或下载）从本网站所获得的任何内容信息，包括但不限于广告、商户信息、点评内容等，不保证其准确性、完整性、可靠性；对于用户因本网站上的内容信息而购买、获取的任何产品、服务、信息或资料，惠校园网不承担责任。用户自行承担使用本网站信息内容所导致的风险。</br>
		5、惠校园网内所有用户所发表的用户点评，仅代表用户个人观点，并不表示本网站赞同其观点或证实其描述，本网站不承担用户点评引发的任何法律责任。</br>
		6、四和有权删除惠校园网站内各类不符合法律或协议规定的点评，而保留不通知用户的权利。</br>
		7、所有发给用户的通告，惠校园网都将通过正式的页面公告、站内信、电子邮件、客服电话、手机短信或常规的信件送达。任何非经惠校园网正规渠道获得的中奖、优惠等活动或信息，惠校园网不承担法律责任。</br>
		</br>

		八、侵权投诉</br></br>
		1、据《中华人民共和国侵权责任法》第三十六条，任何第三方认为，用户利用惠校园网平台侵害本人民事权益或实施侵权行为的，包括但不限于侮辱、诽谤等，被侵权人有权书面通知惠校园网采取删除、屏蔽、断开链接等必要措施。</br>
		2、据《信息网络传播权保护条例》，任何第三方认为，惠校园网所涉及的作品、表演、录音录像制品，侵犯自己的信息网络传播权或者被删除、改变了自己的权利管理电子信息的，可以向惠校园网提交书面通知，要求惠校园网删除该侵权作品，或者断开链接。通知书应当包含下列内容：</br>
		（一）权利人的姓名（名称）、联系方式和地址；</br>
		（二）要求删除或者断开链接的侵权作品、表演、录音录像制品的名称和网络地址；</br>
		（三）构成侵权的初步证明材料。</br>
		权利人应当对通知书的真实性负责。</br>
		此外，为使惠校园网能及时、准确作出判断，还请侵权投诉人一并提供以下材料：</br>
		3、任何第三方（包括但不限于企业、公司、单位或个人等）认为惠校园网用户发布的任何信息侵犯其合法权益的，包括但不限于以上两点，在有充分法律法规及证据足以证明的情况下，均可以通过下列联系方式通知惠校园网：</br></br>
		...
		（2）侵权信息或作品在惠校园网上的具体链接。</br>
		（3）侵权投诉人的联络方式，以便惠校园网相关部门能及时回复您的投诉，最好包括电子邮件地址、电话号码或手机等。</br>
		（4）投诉内容须纳入以下声明：“本人本着诚信原则，有证据认为该对象侵害本人或他人的合法权益。本人承诺投诉全部信息真实、准确，否则自愿承担一切后果。”</br>
		（5）本人亲笔签字并注明日期，如代理他人投诉的，必须出具授权人签字的授权书。</br>
		5、惠校园网建议用户在提起投诉之前咨询法律顾问或律师。我们提请用户注意：如果对侵权投诉不实，则用户可能承担法律责任。</br>
		</br>
		九、适用法律和裁判地点</br></br>
		1、因用户使用惠校园网站而引起或与之相关的一切争议、权利主张或其它事项，均受中华人民共和国法律的管辖。</br>
		2、用户和惠校园网发生争议的，应首先本着诚信原则通过协商加以解决。如果协商不成，则应向四和所在地人民法院提起诉讼。</br>
		</br>
		十、可分性</br></br>
		如果本协议的任何条款被视为不合法、无效或因任何原因而无法执行，则此等规定应视为可分割，不影响任何其它条款的法律效力。
		</br></br>
		十一、冲突选择</br></br>
		本协议是惠校园网与用户注册成为惠校园网用户，使用惠校园网服务之间的重要法律文件，惠校园网或者用户的任何其他书面或者口头意思表示与本协议不一致的，均应当以本协议为准。
	</p>		
</div>
</div>
<div id="bottom_info">
