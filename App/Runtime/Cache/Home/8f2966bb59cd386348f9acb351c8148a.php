...
<div id="faq01_box">
	...
	<div id="left_nav_box">
		<ul>
			...
			<li><a href="<?php echo U("Help/faq03");?>" class="red">商户/点评</a></li>
		...
		<div>
			<p>问题搜索</p>
			<form>
				<input type="text" placeholder="请输入问题关键字" id="faq03_search_textbox" name="faq03_search_textbox"/>
				<input name="faq03_btn_search" id="faq03_btn_search" type="submit" value="搜索"/>
			</form>
		</div>
	</div>
