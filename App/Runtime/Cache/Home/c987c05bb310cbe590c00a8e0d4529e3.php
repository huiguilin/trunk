...
<div id="left_card">
	...
	<p class="two">
		惠校园网（www.huigl.com）所提供的各项服务的所有权和运作权归桂林四和网络科技有限公司（以下简称“本公司”）。除特别说明或者法律另有特别规定者外，本公司是惠校园网及其中所刊登全部资料、信息的知识产权的唯一所有人。
		</br></br>
		...
		会员保证不将已发表于本站的信息资料，以任何形式发布或授权其它网站（及媒体）使用。同时，惠校园网保留删除站内各类不符合规定点评而不通知会员的权利。
		</br></br>
