	...
	<div id="main">
		...
		<div id="coupon_box">
			...
			<div class="other_coupons_box">
                ...
                <?php if(is_array($other_coupon)): foreach($other_coupon as $key=>$ocoupon): ?><p class="other_coupon_content">[<?php echo ($partner["name"]); ?>]<a href="<?php echo U("Coupon/detail","","","");?>/<?php echo ($ocoupon["coupon_id"]); ?>"><?php echo ($ocoupon["name"]); ?></a></p><?php endforeach; endif; ?>
			</div>
