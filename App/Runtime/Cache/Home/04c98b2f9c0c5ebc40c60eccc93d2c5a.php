		...
		<div id="classification_location_box">
			<div id="content_box">
				<div id="classification_box">
                    ...
                    <?php if(is_array($label_types)): foreach($label_types as $key=>$label_type): if($get_info["label_type"] == $key): ?><li><a href="<?php echo U('Search/search',array('label_type'=>$key),'','');?>" class="current"><?php echo ($label_type); ?></a></li>
                        <?php else: ?>
						<li><a href="<?php echo U('Search/search',array('label_type'=>$key),'','');?>"><?php echo ($label_type); ?></a></li><?php endif; endforeach; endif; ?>
					</ul>
					<?php if(($_GET["label_type"] != '') or ($_GET["cat_id"] != '')): ?><div>
							<ul class="child_classification clearfix">
	                            ...
	                            <?php if(is_array($categories)): foreach($categories as $key=>$category): if($get_info['label_type'] == $category['label_type']): if($get_info['cat_id'] == $category['cat_id']): ?><li><a href="<?php echo U('Search/search',array('label_type'=>$category['label_type'],'cat_id'=>$category['cat_id']),'','');?>" class="current"><?php echo ($category["cat_name"]); ?></a></li>
	                            	<?php else: ?>

									<li><a href="<?php echo U('Search/search',array('label_type'=>$category['label_type'],'cat_id'=>$category['cat_id']),'','');?>"><?php echo ($category["cat_name"]); ?></a></li><?php endif; ?>
				...
				<div id="location_box">
					<p>区域</p><ul class="parent_classification">
                        ...
                        <?php else: ?>
						<li><a href="" class="current">全部</a></li><?php endif; ?>
                        <?php if($get_info["tag"] != '秀峰区'): ?><li><a href="<?php echo U('Search/search',array('tag'=>'秀峰区'),'','');?>">秀峰区</a></li>
                        <?php else: ?>
						<li><a class="current" href="<?php echo U('Search/search',array('tag'=>'秀峰区'),'','');?>">秀峰区</a></li><?php endif; ?>
						<?php if($get_info["tag"] != '象山区'): ?><li><a href="<?php echo U('Search/search',array('tag'=>'象山区'),'','');?>">象山区</a></li>
                        <?php else: ?>
						<li><a class="current" href="<?php echo U('Search/search',array('tag'=>'象山区'),'','');?>">象山区</a></li><?php endif; ?>
                        <?php if($get_info["tag"] != '叠彩区'): ?><li><a href="<?php echo U('Search/search',array('tag'=>'叠彩区'),'','');?>">叠彩区</a></li>
                        <?php else: ?>
						<li><a class="current" href="<?php echo U('Search/search',array('tag'=>'叠彩区'),'','');?>">叠彩区</a></li><?php endif; ?>
                        <?php if($get_info["tag"] != '七星区'): ?><li><a href="<?php echo U('Search/search',array('tag'=>'七星区'),'','');?>">七星区</a></li>
                        <?php else: ?>
						<li><a class="current" href="<?php echo U('Search/search',array('tag'=>'七星区'),'','');?>">七星区</a></li><?php endif; ?>
                        <?php if($get_info["tag"] != '雁山区'): ?><li><a href="<?php echo U('Search/search',array('tag'=>'雁山区'),'','');?>">雁山区</a></li>
                        <?php else: ?>
						<li><a class="current" href="<?php echo U('Search/search',array('tag'=>'雁山区'),'','');?>">雁山区</a></li><?php endif; ?>
					</ul>
					<?php if($_GET['tag'] != ''): ?><div>
							<ul class="child_classification clearfix">
	                            ...
	                            <?php if(is_array($locations)): foreach($locations as $key=>$location): if($get_info['tag'] == $location['belong']): if($get_info['location'] != ''): if($get_info['location'] == $location['id'] ): ?><li><a class="current" href="<?php echo U('Search/search',array('tag'=>$location['belong'],'location'=>$location['id']),'','');?>"><?php echo ($location["name"]); ?></a></li>
											<?php else: ?>
												<li><a href="<?php echo U('Search/search',array('tag'=>$location['belong'],'location'=>$location['id']),'','');?>"><?php echo ($location["name"]); ?></a></li><?php endif; ?>
										<?php else: ?>
											<li><a href="<?php echo U('Search/search',array('tag'=>$location['belong'],'location'=>$location['id']),'','');?>"><?php echo ($location["name"]); ?></a></li><?php endif; ?>
									...
									<?php else: endif; ?>
	                            	<!-- <?php if($get_info['tag'] == $location['belong']): ?><li><a class="current" href="<?php echo U('Search/search',array('tag'=>$location['belong'],'location'=>$location['id']),'','');?>"><?php echo ($location["name"]); ?></a></li>
	                            	 <?php else: ?> -->
										<!-- <li><a href="<?php echo U('Search/search',array('tag'=>$location['belong'],'location'=>$location['id']),'','');?>"><?php echo ($location["name"]); ?></a></li> -->
