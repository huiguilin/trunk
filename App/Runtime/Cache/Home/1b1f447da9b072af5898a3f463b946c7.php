...
<body>
	<div id="top_logo_box">
		<a href="<?php echo U("Index/index");?>" class="logoimg_box"><img src="__PUBLIC__/images/logo2.png" alt="惠桂林" id="logo" /></a>
	...
	<div id="main_box">
		...
		<div class="content_box">
			...
			<p style="color:#ED5565;" class="three"> *本优惠请务必从惠桂林网或其授权网站下载使用，否则无效。 </p>
